...
export const GET_QUESTIONS_LOADER_ID = 'GET_QUESTIONS_LOADER_ID';
export const GET_QUESTIONS_NOTIFICATION = {
  id: 'GET_QUESTIONS_NOTIFICATION_ID',
  type: NotificationType.ERROR,
  message: 'Unable to fetch questions. Please try after sometime.'
};

export const UPDATE_QUESTION_LOADER_ID = 'UPDATE_QUESTION_LOADER_ID';
export const UPDATE_QUESTION_NOTIFICATION = {
  id: 'UPDATE_QUESTION_NOTIFICATION_ID',
  type: NotificationType.ERROR,
  message: 'Unable to update questions. Please try after sometime.'
};

export const ASK_QUESTION_LOADER_ID = 'ASK_QUESTION_LOADER_ID';
export const ASK_QUESTION_NOTIFICATION = {
...
export const GET_BEST_PRACTICES_LOADER_ID = 'GET_BEST_PRACTICES_LOADER_ID';
export const GET_BEST_PRACTICES_NOTIFICATION = {
...
export const GET_BEST_PRACTICES_ASSESSMENTS_NOTIFICATION = {
  ...
  type: NotificationType.ERROR,
  message: 'Unable to fetch best practices assessments. Please try after sometime.'
};

export const SAVE_BEST_PRACTICES_ASSESSMENTS_LOADER_ID = 'SAVE_BEST_PRACTICES_ASSESSMENTS_LOADER_ID';
export const SAVE_BEST_PRACTICES_ASSESSMENTS_NOTIFICATION = {
